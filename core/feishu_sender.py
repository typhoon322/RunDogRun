            ...
            "elements": [
                {
                    ...
                    "text": {
                        "content": (
                            ...
                            f"Trend: {trend:.0f}  |  Flow: {flow:.0f}  |  Value: {value:.0f}\n"
                            f"市场状态: {market_state}"
                        ),
                        "tag": "lark_md",
                    },
                ...
                {"tag": "hr"},
                {
                    ...
                    "text": {
                        "content": (
                            ...
                            f"Risk: {'COMPRESSED' if position.get('compressed') else 'NORMAL'}\n"
                            f"Allow Trade: {'YES' if decision['allow_trade'] else 'NO'}"
                        ),
                        "tag": "lark_md",
                    },
                },
                {"tag": "hr"},
                {
                    "tag": "div",
                    "text": {
                        "content": f"**Action:** {decision['reason']}\n\n"
